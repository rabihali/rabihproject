...
if (isset($_POST['add_to_cart'])) {
    ...
    $select_cart = mysqli_query($c, "SELECT * FROM `cart` WHERE name = '$product_name' AND user_id = '$user_id'");

    if (mysqli_num_rows($select_cart) > 0) {
        $message[] = 'product already added to cart!';
    } else {
        mysqli_query($c, "INSERT INTO `cart`(user_id, name, price, image, quantity) VALUES('$user_id', '$product_name', '$product_price', '$product_image', '$product_quantity')");
        $message[] = 'product added to cart! done';
    }
};
...
if (isset($_POST['update_cart'])) {
    ...
    mysqli_query($c, "UPDATE `cart` SET quantity = '$update_quantity' WHERE id = '$update_id'");
    $message[] = 'cart quantity updated successfully!';
}

if (isset($_GET['remove'])) {
    $remove_id = $_GET['remove'];
    mysqli_query($c, "DELETE FROM `cart` WHERE id = '$remove_id'");
        ...
        <div class="container">
            ...
            <div class="products">
                ...
                <div class="box-container">
                    ...
                    <?php
                    $select_product = mysqli_query($c, "SELECT * FROM `products`");
